        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="image-upload-container">
              <div class="image-preview" v-if="imagePreview || (category && category.image_url)">
                <img :src="imagePreview || category.image_url" alt="Preview">
...
watch(() => props.category, (newCategory) => {
  if (newCategory && props.mode === 'edit') {
    formData.name.ar = newCategory.name.ar || ''
    formData.name.en = newCategory.name.en || ''
    formData.is_featured = newCategory.is_featured || false
    formData.is_popular = newCategory.is_popular || false
  }
}, { immediate: true })
...
const validateForm = () => {
  ...
  if (props.mode === 'create' && !imageFile.value) {
    errors.photo = 'Category image is required'
    isValid = false
  }
...
const handleSubmit = async () => {
  ...
  try {
    ...
    errorMessage.value = error.message || 'Failed to save category'
