            ...
            <table class="table table-hover table-striped table-bordered align-middle">
                ...
                <tbody>
                    @forelse($subCategories as $subCategory)
                        <tr>
                            <td><span class="badge badge-secondary">{{ $subCategory->id }}</span></td>
                            <td>
                                @php
                            ...
                            <td><span class="badge badge-primary">{{ $subCategory->servicePosts ? $subCategory->servicePosts->count() : 0 }}</span></td>
                            <td><span class="text-muted">{{ $subCategory->created_at ? $subCategory->created_at->format('Y-m-d') : '-' }}</span></td>
                            <td>
                                <a href="{{ route('subcategories.show', $subCategory->id) }}" class="btn btn-xs btn-outline-info" data-toggle="tooltip" title="View"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('subcategories.edit', $subCategory->id) }}" class="btn btn-xs btn-outline-primary" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
