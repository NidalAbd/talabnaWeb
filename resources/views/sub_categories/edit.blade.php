...
@section('content_header')
    ...
    <div class="d-flex justify-content-between align-items-center">
        <h1>
            ...
            Edit Subcategory: <span class="text-muted">{{ $subcategory->id }}</span>
        </h1>
        <div>
                            ...
                            @if(session('success'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">{{('sub_categories\edit._times_') }}</span>
                                    </button>
                                </div>
                            @endif
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                        <label for="categories_id" class="font-weight-bold">
                                            ...
                                            Parent Category <span class="text-danger">{{('sub_categories\edit._') }}</span>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name_ar" class="font-weight-bold">
                                            ...
                                            Arabic Name <span class="text-danger">{{('sub_categories\edit._') }}</span>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name_en" class="font-weight-bold">
                                            <i class="fas fa-language mr-1"></i>
                                            English Name <span class="text-danger">{{('sub_categories\edit._') }}</span>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="isSuspended" id="status" class="form-control @error('isSuspended') is-invalid @enderror">
                                            <option value="0" {{ old('isSuspended', $subcategory->isSuspended) }}>Inactive</option>
                                            <option value="1" {{ old('isSuspended', $subcategory->isSuspended) }}>Active</option>
                                        </select>
                                        @error('isSuspended')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="photo">{{('sub_categories\edit.choose_new_image_or_keep_existing_') }}</label>
                                            @error('photo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header bg-light">
                                            <h6 class="mb-0">{{('sub_categories\edit.current_image') }}</h6>
                                        </div>
