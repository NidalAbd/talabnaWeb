                            ...
                            @if(session('success'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">{{ __('categories\create._times_') }}</span>
                                    </button>
                                </div>
                            @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name_ar" class="font-weight-bold">
                                            ...
                                            Arabic Name <span class="text-danger">{{ __('categories\create._') }}</span>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name_en" class="font-weight-bold">
                                            <i class="fas fa-language mr-1"></i>
                                            English Name <span class="text-danger">{{ __('categories\create._') }}</span>
                                        </label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="photo" class="font-weight-bold">
                                            ...
                                            Category Image <span class="text-danger">{{ __('categories\create._') }}</span>
                                        </label>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input @error('photo') is-invalid @enderror"
                                                   id="photo" name="photo" required onchange="previewImage(this)">
                                            <label class="custom-file-label" for="photo">{{ __('categories\create.choose_file_') }}</label>
                                            @error('photo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div id="image-preview-container" class="text-center d-none mt-3">
                                        <div class="card">
                                            <div class="card-header bg-light">
                                                <h6 class="mb-0">{{ __('categories\create.image_preview') }}</h6>
                                            </div>
                                            <div class="card-body">
