...
<div class="container-fluid">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{('admin\investor\dashboard.investor_dashboard') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{('admin\investor\dashboard.dashboard') }}</a></li>
                        <li class="breadcrumb-item active">{{('admin\investor\dashboard.investor') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        <div class="inner">
                            ...
                            <p>{{('admin\investor\dashboard.total_revenue_sar_') }}</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        <div class="inner">
                            ...
                            <p>{{('admin\investor\dashboard.monthly_revenue_sar_') }}</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            ...
                            <p>{{('admin\investor\dashboard.total_users') }}</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        <div class="inner">
                            ...
                            <p>{{('admin\investor\dashboard.active_posts') }}</p>
                        </div>
                        <div class="icon">
            ...
            <div class="row mb-4">
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-gradient-success">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">{{('admin\investor\dashboard.user_growth') }}</span>
                ...
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-gradient-info">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">{{('admin\investor\dashboard.revenue_growth') }}</span>
                ...
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-gradient-warning">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">{{('admin\investor\dashboard.engagement_rate') }}</span>
                ...
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-gradient-danger">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">{{('admin\investor\dashboard.premium_users') }}</span>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>{{('admin\investor\dashboard.metric') }}</th>
                                            <th>{{('admin\investor\dashboard.value') }}</th>
                                            <th>{{('admin\investor\dashboard.change') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td>{{('admin\investor\dashboard.new_users_this_month_') }}</td>
                                        ...
                                        <tr>
                                            <td>{{('admin\investor\dashboard.active_users_this_week_') }}</td>
                                        ...
                                        <tr>
                                            <td>{{('admin\investor\dashboard.premium_subscriptions') }}</td>
                                        ...
                                        <tr>
                                            <td>{{('admin\investor\dashboard.average_session_duration') }}</td>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>{{('admin\investor\dashboard.period') }}</th>
                                            <th>{{('admin\investor\dashboard.revenue') }}</th>
                                            <th>{{('admin\investor\dashboard.growth') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td>{{('admin\investor\dashboard.this_month') }}</td>
                                        ...
                                        <tr>
                                            <td>{{('admin\investor\dashboard.last_month') }}</td>
                                        ...
                                        <tr>
                                            <td>{{('admin\investor\dashboard.this_quarter') }}</td>
                                        ...
                                        <tr>
                                            <td>{{('admin\investor\dashboard.this_year') }}</td>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>{{('admin\investor\dashboard.date') }}</th>
                                            <th>{{('admin\investor\dashboard.user') }}</th>
                                            <th>{{('admin\investor\dashboard.package') }}</th>
                                            <th>{{('admin\investor\dashboard.amount') }}</th>
                                            <th>{{('admin\investor\dashboard.status') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center">{{('admin\investor\dashboard.no_recent_transactions_found_') }}</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
