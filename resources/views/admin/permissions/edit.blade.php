                        ...
                        <div class="card-body">
                            @if($isSystemPermission)
                                <div class="alert alert-warning">
                                    ...
                                    This is a system permission and has limited editing capabilities. You can only modify the display name and description.
                                </div>
                            @endif
                                        ...
                                        <div class="input-group">
                                            ...
                                            @if($isSystemPermission)
                                                <input type="text" class="form-control"
                                                       id="name" value="{{ $permission->name }}" readonly disabled>
                                            @else
