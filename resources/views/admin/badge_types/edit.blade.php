...
@section('title', 'Edit Badge Type - Talabna Admin')
...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">Update badge type: {{ $badgeType->name_en }}</p>
        </div>
    ...
    <div class="row">
            ...
            <div class="card card-outline card-primary shadow-sm">
                <div class="card-header">
                    ...
                    @if($badgeType->is_default)
                        <span class="badge badge-info float-right">Default Badge</span>
                    @endif
                </div>
                <form action="{{ route('badge_types.update', $badgeType->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror"
                                           id="name_ar" name="name_ar" value="{{ old('name_ar', $badgeType->name_ar) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                                           id="name_en" name="name_en" value="{{ old('name_en', $badgeType->name_en) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                           id="slug" name="slug" value="{{ old('slug', $badgeType->slug) }}"
                                           placeholder="badge-slug" required>
                                    @error('slug')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="icon-preview">
                                                <i class="{{ $badgeType->icon }}"></i>
                                            </span>
                                        </div>
                                        <input type="text" class="form-control @error('icon') is-invalid @enderror"
                                               id="icon" name="icon" value="{{ old('icon', $badgeType->icon) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="color" class="form-control form-control-color" id="color_picker"
                                               value="{{ old('color', $badgeType->color) }}" style="width: 50px; padding: 2px;">
                                        <input type="text" class="form-control @error('color') is-invalid @enderror"
                                               id="color" name="color" value="{{ old('color', $badgeType->color) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('priority') is-invalid @enderror"
                                           id="priority" name="priority" value="{{ old('priority', $badgeType->priority) }}"
                                           min="1" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('points_per_day') is-invalid @enderror"
                                               ...
                                               value="{{ old('points_per_day', $badgeType->points_per_day) }}"
                                               min="0" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('view_boost_percent') is-invalid @enderror"
                                               ...
                                               value="{{ old('view_boost_percent', $badgeType->view_boost_percent) }}" min="0">
                                        <div class="input-group-append">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1"
                                       {{ old('is_active', $badgeType->is_active) ? 'checked' : '' }}
                                       {{ $badgeType->is_default ? 'disabled' : '' }}>
                                <label class="custom-control-label" for="is_active">Active</label>
                            </div>
                            @if($badgeType->is_default)
                                <small class="text-warning">Default badge cannot be deactivated</small>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save mr-1"></i> Update Badge Type
                        </button>
                        <a href="{{ route('badge_types.index') }}" class="btn btn-secondary">
        ...
        <div class="col-lg-4">
            <div class="card card-outline card-info shadow-sm">
                ...
                <div class="card-body text-center">
                    <div class="badge-preview p-4 rounded" style="background: linear-gradient(135deg, #f5f5f5 0%, #e0e0e0 100%);">
                        <i id="preview-icon" class="{{ $badgeType->icon }}" style="font-size: 64px; color: {{ $badgeType->color }};"></i>
                        <h4 id="preview-name-en" class="mt-3 mb-1">{{ $badgeType->name_en }}</h4>
                        <p id="preview-name-ar" class="text-muted mb-3">{{ $badgeType->name_ar }}</p>
                        <div class="d-flex justify-content-center">
                            <span id="preview-points" class="badge badge-warning mr-2">{{ $badgeType->points_per_day }} pts/day</span>
                            <span id="preview-boost" class="badge badge-info">+{{ $badgeType->view_boost_percent }}% boost</span>
                        </div>
                    </div>
            ...
            <div class="card card-outline card-secondary shadow-sm mt-3">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-chart-bar mr-2"></i> Badge Statistics
                    </h3>
                </div>
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Created
                            <span class="text-muted">{{ $badgeType->created_at->format('M d, Y') }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Last Updated
                            <span class="text-muted">{{ $badgeType->updated_at->format('M d, Y') }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Active Posts
                            <span class="badge badge-primary badge-pill">{{ $badgeType->servicePosts()->count() }}</span>
                        </li>
                    </ul>
                </div>
            </div>
