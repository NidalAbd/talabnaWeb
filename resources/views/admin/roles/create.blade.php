...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-plus-circle text-success mr-2"></i> Create New Role</h1>
            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('admin\roles\create.role_information') }}</h3>
                    </div>
                    ...
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Role Name <span class="text-danger">{{ __('admin\roles\create._') }}</span></label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                   ...
                                                   placeholder="Enter a unique role name (e.g. editor, manager)" required>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="display_name">{{ __('admin\roles\create.display_name') }}</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                            ...
                            <div class="form-group">
                                <label for="description">{{ __('admin\roles\create.description') }}</label>
                            ...
                            <p class="text-muted">{{ __('admin\roles\create.select_the_permissions_that_will_be_assi') }}</p>
