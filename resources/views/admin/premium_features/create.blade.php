                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('category') is-invalid @enderror" id="category" name="category" required>
                                        ...
                                        <option value="post_enhancement" {{ old('category') == 'post_enhancement' ? 'selected' : '' }}>Post Enhancement</option>
                                        <option value="user_benefit" {{ old('category') == 'user_benefit' ? 'selected' : '' }}>User Benefit</option>
                                        <option value="system_feature" {{ old('category') == 'system_feature' ? 'selected' : '' }}>System Feature</option>
                                        <option value="premium_access" {{ old('category') == 'premium_access' ? 'selected' : '' }}>Premium Access</option>
