...
<head>
  ...
  <title>{{ __('vendor\laratrust\panel\layout.laratrust_yield_title_') }}</title>
  ...
  <nav class="bg-gray-800">
        ...
        <div class="flex items-center">
          <div class="hidden md:block">
            <div class="flex items-baseline">
              <a href="{{config('laratrust.panel.go_back_route')}}" class="nav-button">{{ __('vendor\laratrust\panel\layout._go_back') }}</a>
              <a
    ...
    <div class="hidden md:hidden">
      <div class="px-2 pt-2 pb-3 sm:px-3">
        <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700">{{ __('vendor\laratrust\panel\layout.dashboard') }}</a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">{{ __('vendor\laratrust\panel\layout.team') }}</a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">{{ __('vendor\laratrust\panel\layout.projects') }}</a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">{{ __('vendor\laratrust\panel\layout.calendar') }}</a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">{{ __('vendor\laratrust\panel\layout.reports') }}</a>
      </div>
    </div>
  </nav>
