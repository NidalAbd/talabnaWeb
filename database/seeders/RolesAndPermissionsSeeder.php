...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            ['name' => 'user_index', 'display_name' => 'View User Index','created_at' => Carbon::now()],
            ...
            ['name' => 'suspend_category', 'display_name' => 'Suspend Category','created_at' => Carbon::now()],
            ['name' => 'suspend_subcategory', 'display_name' => 'Suspend Subcategory','created_at' => Carbon::now()],
            ['name' => 'view_user', 'display_name' => 'View User Details','created_at' => Carbon::now()],
            ['name' => 'update_profile', 'display_name' => 'Update Profile','created_at' => Carbon::now()],
            ['name' => 'show_profile', 'display_name' => 'Show Profile','created_at' => Carbon::now()],
        ];
        ...
        // Attach role and sync permissions SEPARATELY
        $adminUser->attachRole($adminRole);
        $adminUser->syncPermissions($adminPermissions);

        // Create photo for admin user
        $photo = new Photos([
        ...
        // Attach role and sync permissions SEPARATELY
        $ModeratorUser->attachRole($moderatorRole);
        $ModeratorUser->syncPermissions($moderatorPermissions);

        // Create photo for moderator user
        $photo = new Photos([
            'src' => fake()->randomElement([
                'storage/photos/avatar1.png',
                'storage/photos/avatar2.png',
