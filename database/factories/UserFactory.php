...
class UserFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        Log::info($city);
        // Check if city is null and provide a default city
        if (!$city) {
            // Handle case where no city is found, either create a default city or handle gracefully
            $city = cities::first(); // You can modify this to set a default city or handle it differently
        }
        return [
