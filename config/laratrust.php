...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the array that contains the information of the userController models.
    | This information is used in the add-trait command, for the roles and
    | permissions relationships with the possible userController models, and the
    ...
    */
    'middleware' => [
        ...
        'handlers' => [
            ...
            /**
             * Redirects the userController to the given url.
    ...
    'teams' => [
        ...
        */
        ...
        | it will check only if the userController has attached that role/permission ignoring the team.
        |
        */
        'strict_check' => false,
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Determines if you can check if a userController has a permission using the "can" method.
    |
    */
    ...
    */
    'panel' => [
        ...
        */
        'roles_restrictions' => [
            // The userController won't be able to remove roles already assigned to users.
            'not_removable' => [],

            // The userController won't be able to edit the role and the permissions assigned.
            'not_editable' => [],

            // The userController won't be able to delete the role.
            'not_deletable' => [],
        ],
    ]
];
